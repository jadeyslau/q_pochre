...
def tidy_df(df, treatment=False):
    ...
    sample_bio_rep = asarray([re.sub("[^A-Z\d]", "", re.search("/\d+$/", i).group(0).upper()) for i in df['Sample']])
...
#     df.loc[df.Cq > 40, x]= 0
    ...
    columns_titles = ['Sample', 'Target', 'Cq', 'Cq Mean', 'Cq Error', 'Replicate Group', 'Condition', 'Treatment', 'Plate']
